  ...
  return (
    <section className="flex w-full flex-col p-8">
      ...
      <div className="flex  w-[12rem] pt-4">
        <p className="flex text-primary">Home <span className="pt-1 px-1"><FaChevronRight/></span> Find station <span className="pt-1 px-1"><FaChevronRight/></span></p>
      </div>
      ...
      <div className="flex flex-col pt-8">
        ...
        <div className="flex  pt-4">
          ...
          <input placeholder="Search a location" className="w-[35rem] p-1 border-2 border-primary rounded-full pl-5 placeholder-[#7e3b98] placeholder:font-medium focus:outline-none"></input>
          <IoMdSearch className="text-primary text-xl absolute top-3 right-4"/>
          </div>
          <div className='flex justify-center  pl-6 w-[16rem] relative'><button className="relative py-2 w-full whitespace-nowrap text-primary font-medium rounded-full  transition-all duration-400  bg-gray-200/70 hover:scale-105 active:scale-100"><MdMyLocation className="text-2xl absolute left-6 "/> Use my location</button>
          </div>
          </div>
          <div className="flex pl-[3rem] gap-4">
          <div className='flex'><button className="px-8 py-2 w-full whitespace-nowrap text-primary font-medium rounded-full border-2 border-primary transition-all duration-400 hover:scale-105   active:scale-100">Select a fuel type</button>
          </div>
          <div className='flex'><button className="px-6 py-2 w-full whitespace-nowrap bg-primary text-white font-medium rounded-full border-2 border-primary transition-all duration-400 hover:scale-105 active:scale-100">Show prices</button>
          </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col border-2 border-gray-200 rounded-l-3xl h-full ">
          <div className="flex justify-center w-[21rem]">
            <div className="flex w-full justify-center py-4 font-medium cursor-pointer">
              <h3 onClick={() => setSelectedDiv(1)} className="active:scale-95 hover:scale-105">Filters</h3>
            </div>
            <div className="flex w-full justify-center bg-gray-200/70 py-4 text-primary font-medium cursor-pointer ">
              <h3 onClick={() => setSelectedDiv(2)} className="active:scale-95 hover:scale-105">Stations</h3>
            </div>
          </div>
          ...
          <div className='flex '><button className="relative px-8 py-2 w-full whitespace-nowrap text-primary font-medium rounded-full border-2 border-gray-200 transition-all active:scale-95"><BsFuelPumpFill className="absolute text-[1.3rem] top-2 left-5"/>Service Station</button>
          </div>
            </div>
