                ...
                <div className="flex justify-center max-w-[80rem] h-[37rem] relative ">
                    ...
                    <div className="flex flex-col top-[11rem] left-[5rem] absolute w-[25rem]">
                        ...
                        <div className="flex w-[12rem] pt-8 ml-1">
                            <button className="px-6 p-3 mt-2 w-full whitespace-nowrap text-black text-lg font-normal rounded-full bg-action transition-all duration-400 hover:scale-105 active:scale-100">
                                Find a Station
                            </button>
                        </div>
                    </div>
