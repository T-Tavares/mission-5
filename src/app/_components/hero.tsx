  ...
  return (
    ...
    <section className="flex flex-col mx-auto xl:hidden">
      <div className="flex justify-center -mt-[5rem] lg:mt-[5rem]">
        ...
        <div className="flex flex-col mx-auto w-[27rem] pt-[4rem] gap-10  xl:flex xl:flex-row xl:justify-center xl:gap-[11rem]">
          ...
          <p className="text-base font-normal">Save 6c per litre every time you fill up to 50 litres. Or stack your discount for later. Plus earn Flybuys or Airpoints Dollars.</p>
          </div>
          ...
          <p className="text-base font-normal">Z App lets you experience Z your way. Pay for fuel, pre-buy with Sharetank, pre-order drinks, offset your carbon emissions.</p>
          </div>
    ...
    <section className="hidden xl:flex xl:flex-col ">
      <div className="flex justify-center pt-[9rem] ">
        ...
        <div className="flex flex-col mx-auto pt-[4rem] gap-10  xl:flex xl:flex-row xl:justify-center xl:gap-[11rem]">
          ...
          <p className="text-lg font-normal">Save 6c per litre every time you fill up to 50 litres. Or stack your discount for later. Plus earn Flybuys or Airpoints Dollars.</p>
          </div>
          ...
          <p className="text-lg font-normal">Z App lets you experience Z your way. Pay for fuel, pre-buy with Sharetank, pre-order drinks, offset your carbon emissions.</p>
          </div>
    ...
    <section className="flex w-full justify-center bg-gray-200/80 lg:bg-white lg:-mx-8 pt-[10rem]">
      ...
      <div className="pl-2  xl:flex xl:flex-1 xl:pl-[8rem]">
        ...
        <p className="text-lg font-normal py-9">Z's been committed to keeping you moving on the road for over a decade and now we're here to help you keep moving at home too.</p>
        <p className="text-lg font-normal">Our specialised home power plans will help you keep your home and vehicle running, with plans for both EV and non-EV drivers.</p>
        </div>
        <div className='flex w-[13rem] py-9 '><button className="px-6 py-2 w-full whitespace-nowrap text-primary text-lg font-medium rounded-full border-2 border-primary transition-all duration-400 hover:scale-105 hover:bg-primary hover:text-white active:scale-100">Find out more</button>
          </div>
        </div>  
      </div>
    ...
    <section className="flex flex-row w-full justify-center py-10 p-2 xl:py-[10rem]">
      ...
      <div className="flex flex-col mx-auto w-[26rem] xl:w-[29rem]">
        ...
        <p className="text-lg font-normal py-4">Moving furniture? Hangry for a pie and barista made coffee? Have a dirty car that needs some love? Come on in — we've got you covered.</p>
        <div className='flex w-[12rem] py-9 '><button className="px-6 py-2 w-full whitespace-nowrap text-primary text-lg font-medium rounded-full border-2 border-primary transition-all duration-400 hover:scale-105 hover:bg-primary hover:text-white active:scale-100">Services</button>
          </div>
      </div>
